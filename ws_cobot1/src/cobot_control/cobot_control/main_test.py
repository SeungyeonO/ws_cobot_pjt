    ...
    try:
        while rclpy.ok():
            ...
            if order_received:
                ...
                controller.move_to_pose(PERFUME_POSE, from_home=True, down=103.58, velocity=100, acceleration=50)    # 향수병 상단 - 향수병 뚜껑
                ...
                controller.move_to_pose(goal_pose=PERFUME_LID_POSE, up=103.58, down=117.2) # 향수 뚜껑 보관함 상단 - 향수 뚜껑 놓는 위치
                controller.release()
                # ======================================
                ...
                for i in range(6):
                    ...
                    for drop in range(drops):
                        ...
                        if first:
                            ...
                            wait(0.5)
                            controller.move_to_pose(goal_pose=scent_pose, up=117.2, down=81.23)   # scent 상단 - 스포이드 위치
